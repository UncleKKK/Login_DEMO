...
export default {
  ...
  setup (props){
      ...
      const styleRef = reactive({
          is_show_pwd:false,
          show_pwd_src:require('@/assets/sources/hide_pwd_icon.svg')
      })
      // -- username input fun
      ...
      const show_pwd_icon_tap_action = () =>{
        ...
        if(!styleRef.is_show_pwd){
            styleRef.show_pwd_src = require('@/assets/sources/hide_pwd_icon.svg')
            ...
            styleRef.show_pwd_src = require('@/assets/sources/show_pwd_icon.svg')
            if(0 !== dataRef.password.length){
