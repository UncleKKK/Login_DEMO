...
import { request_manger_get,reqeust_manger_post } from '@/utils/httpManger'
import { set_storage_for_token,get_storage_for_token } from '@/utils/storage'
import InputBox from '@/components/InputBox.vue'
import Register from '@/components/Register.vue'
import LoginComponent from '@/components/LoginComponent.vue'
import ForgetPassword from '@/components/ForgetPassword.vue'
import BackgroundSquare from '@/components/BackgroundSquare.vue'
...
.container .container-main
{
  ...
  background:url('../assets/sources/light.png') no-repeat;
